...
console.log('\nInitial example:');
const trip = new Trip([new Bicycle(), new Bicycle(), new Bicycle()], [new Customer(), new Customer()], new Vehicle());
...
const trip2 = new TripUsingInstanceOf([new Bicycle(), new Bicycle(), new Bicycle()], [new Customer(), new Customer()], new Vehicle());
...
console.log('\nin operator example:');
const trip3 = new TripUsingInOperator([new Bicycle(), new Bicycle(), new Bicycle()], [new Customer(), new Customer()], new Vehicle());
preparers = [new TripCoordinator(), new Driver(), new Mechanic()];
